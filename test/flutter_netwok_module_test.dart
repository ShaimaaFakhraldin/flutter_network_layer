...
import 'package:flutter_network_layer/app_module/core/src/entity/entity.dart';
import 'package:flutter_network_layer/app_module/core/src/utils/result.dart';
import 'package:flutter_network_layer/app_module/network/flutter_netwok_module.dart';
...
class SampleEntityParser extends EntityParser<SampleEntity> {
  @override
  SampleEntity parseObject(dynamic json) {
    return SampleEntity();
  }
}
